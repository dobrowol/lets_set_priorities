...
PASlabels = [['PASmotorbike','PASmotorbikeSide'],['PASbicycle','PASbicycleSide'],['PASperson','PASpersonSitting',
                                                                                  'PASpersonStanding','PASpersonWalking'],
             ['PAScar','PAScarFrontal','PAScarRear','PAScarSide']]
